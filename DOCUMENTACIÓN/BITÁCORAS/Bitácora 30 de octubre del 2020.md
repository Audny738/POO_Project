Se presentaron los requerimientos, se llego a un acuerdo de realizar modificaciones, a cada requerimiento se le asigno una prioridad, esto servirá para tener un mejor orden. 
